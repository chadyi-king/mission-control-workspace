                ...
                try:
                    ...
                    if bool(signal_state.get("runner_active", False)) and remaining_units > 0:
                        ...
                        while True:
                            ...
                            remaining_units = max(remaining_units - closed, 0)
                            new_sl = self._runner_sl_price(symbol, direction, first_entry, next_trigger)
                            ...
                            self.log.info("runner step applied signal_id=%s trigger=%s sl=%s", signal_id, next_trigger, new_sl)
